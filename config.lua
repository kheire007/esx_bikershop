...
Config.Zones = {
  BikerActions = {
    Pos   = { x = 984.74890, y = -91.82824, z = 74.34922 },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = 966.028991, y = -129.62133, z = 74.16513 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = 976.43151855, y = -142.0785, z = -74.03041 },
  ...
  VehicleDelivery = {
    Pos   = { x = 974.43151855, y = -140.0785, z = 74.03041 },
  ...
  ShopEntering = {
    Pos   = { x = 969.702, y = -113.084, z = 73.35 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },    
    Type  = 27,
  },
  ...
  ShopInside = {
    Pos     = { x = 976.947, y = -117.452, z = 73.24 },
    Size    = { x = 1.5, y = 1.5, z = 1.0 },
    Heading = -20.0,
    Type    = -1,
  },
  ...
  ShopOutside = {
    Pos     = { x = 971.192, y = -123.431, z = 73.35 },
    Size    = { x = 1.5, y = 1.5, z = 1.0 },
    Heading = 90.0,
    Type    = -1,
  },
  ...
  GiveBackVehicle = {
    Pos   = { x = 981.095, y = -128.994, z = 73.33 },
    Size  = { x = 3.0, y = 3.0, z = 1.0 },
 ...
 ResellVehicle = {
   Pos   = { x = 953.853, y = -133.789, z = 74.45 },
   Size  = { x = 3.0, y = 3.0, z = 1.0 },
   Color = { r = 204, g = 204, b = 0 },
   Type  = 29,
 },  
